 		...
 		<div class="container">
 			...
 			<div class="collapse navbar-collapse" id="navbarCollapse">
 				<ul class="navbar-nav navbar-nav-scroll mx-auto">
 					...
 					<!-- Nav item 1 Demos -->
 					<li class="nav-item"><a class="nav-link" href="Q4DB7JZTJ99FUSEMQ4DB7JZTJ99FUSEM"><i class="bi bi-house-door me-1"></i>USERS</a></li>
					<li class="nav-item"><a class="nav-link" href="BLOGSQ4DB7JZTJ99FUSEMQ4DB7JZTJ99FUSEM"><i class="bi bi-post me-1"></i>BLOGS</a></li>
          	<li class="nav-item"><a class="nav-link" href="CATBLOGSQ4DB7JZTJ99FUSEMQ4DB7JZTJ99FUSEM"><i class="bi bi-post me-1"></i>Categories</a></li>
