...
if (isset($_POST['submit'])) {
  ...
  move_uploaded_file($post_image_temp,"../img/category/$post_image");

  $query="INSERT INTO category(name,img) values ('$name','$post_image')";
  $result=mysqli_query($connection,$query);
  header("location:CATBLOGSQ4DB7JZTJ99FUSEMQ4DB7JZTJ99FUSEM");
}
 ...
 ?>
            ...
            <div class="mb-3">
              ...
              <input required id="con-name" name="name" type="text" class="form-control" placeholder="Post name" required>
            ...
            <div class="col-6">
              ...
              <div class="position-relative">
                <h6 class="my-2">CATEGORY IMAGE<a href="#!" class="text-primary"> Browse</a></h6>
            ...
            <div class="col-md-3 text-start">
              <button class="btn btn-primary w-100" name="submit" type="submit">Create category</button>
            </div>
          </form>
...
$result=mysqli_query($connection,$query);
 ...
 ?>
            ...
            <a href="#" class="btn btn-primary-soft w-100 mb-0">View posts</a><br>
						<a href="#" class="btn btn-danger-soft w-100 mb-0">delete</a>
					</div>
				</div>
				<!-- Category item END -->
			</div>
