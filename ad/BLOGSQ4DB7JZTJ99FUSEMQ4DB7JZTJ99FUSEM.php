    ...
    <div class="row pb-4">
        ...
        <!-- Title -->
				<div class="d-sm-flex justify-content-sm-between align-items-center">
					<h1 class="mb-2 mb-sm-0 h2">MANAGE BLOGS </h1>
                ...
                <table class="table align-middle p-4 mb-0 table-hover table-shrink">
                  ...
                  <thead class="table-dark">
                    <tr>
                      ...
                      <th scope="col" class="border-0">img</th>
...
$category=$row['category'];
 ...
 ?>
                    ...
                    <tr>
                      <!-- Table data -->
                      <td>
                        <h6 class="course-title mt-2 mt-md-0 mb-0"><a href="#"><?php echo $title; ?></a></h6>
                      </td>
                      <!-- Table data -->
                      <!-- <td>
                      ...
                      <!-- Table data -->
                      <td>
<img src="../img/<?php echo $img ?>" alt="" width="100">
                      </td>
                      <td><?php echo $date; ?></td>
											<td><?php echo $tags; ?></td>
                      ...
                      <td>
                        <div class="d-flex gap-2">
                          <a href="includes/delete.php?bdelete=<?php echo $id; ?>" class="btn btn-light btn-round mb-0" data-bs-toggle="tooltip" onclick="return confirm('are you sure?')" data-bs-placement="top" title="Delete"><i class="bi bi-trash"></i></a>
